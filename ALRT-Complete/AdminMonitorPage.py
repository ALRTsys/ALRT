...
class AdminMainApp(ft.UserControl):
    ...
    def button_clicked(self, e):
     ...
     # // ----- Log file ------------------------//
            ...
            self.page.route = "/contactAdminMonitor"
            self.page.update()
        elif data == 5:
    ...
    def build(self):
        ...
        # // ----------  Logs --------------------------------------------------------//
        self.log_report = ft.TextButton(
            width=100,
            content=ft.Container(
                alignment=ft.alignment.center,
                content=ft.Text("Logs", size=16, )),
            on_hover=self.on_hover,
            style=ft.ButtonStyle(shape=ft.CountinuosRectangleBorder(radius=0),
                                 color=ft.colors.WHITE
                                 ),
        ...
        self.log_out_btn = ft.TextButton(
            ...
            on_click=self.button_clicked, data=5)
        ...
        self.st = ft.Stack(
            [
                ...
                ft.Container(
                    content=ft.Image(
                        src=f"/images/monitor admin.png",
                        width=1300,
                        height=700,
                        expand=1,
                ...
                ft.Column(
                    ...
                    controls=[
                        self.monitor_btn,
                        ft.Container(height=-3),  # space between monitor and close alert  # 20
                        self.close_alert_btn,
                        ft.Container(height=2),  # space between close and help center #90
                        self.log_report,
                ...
                ft.Row(controls=[
                    ...
                    alignment=ft.MainAxisAlignment.CENTER,
                    width=1200,
                    top=110,  # used to space video in right place
